    ...
    >
      ...
      <div className="animate-pulse text-red-500">
          <h2 className="text-xl sm:text-2xl mb-4 font-bold tracking-tight text-red-900 dark:text-red-500">
            BuildSEC'24 Registration is now open.
          </h2>
        </div>
      ...
      <div className="w-full text-left flex flex-col justify-center items-center">
        ...
        <table className="w-full text-left">
          <tr>
            <th>  Bank Information (REQUIRED)*</th>
            <td></td>
            </tr>
           <tr> 
            <th>Account Number*:</th>
            <td>50200102839111</td>
          </tr>
          <tr>
          ...
          <tr>
            <th>Bank Address:*</th>
            <td>HDFC BANK LTD, Okhla Phase–III, Delhi-110020</td>
          </tr>
          <tr>
            <th>Country:*</th>
            <td>India</td>
        ...
        <table className="w-full text-left">
          <tr>
            <th>  FOR INDIA WIRE TRANFERS ONLY:</th>
            <td></td>
            </tr>
           <tr> 
            <th>IFSC Code:</th>
        ...
        <p className="text-gray-600 dark:text-gray-400 text-left text-bold"> Currency: AED, AUD, CAD, CHF, CZK, DKK, EUR, FJD, GBP, HKD, HUF, INR, ILS, JPY ,KRW, KWD, MXN, NZD, NOK, PGK, PHP, PLN, QAR, SAR, SEK, SGD, THB, TRY, TWD, USD, ZAR </p>
        <p className="text-gray-600 dark:text-gray-400 text-left"> (Please note if your currency is not listed, the transfer will default to USD)  </p>
